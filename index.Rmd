...
You can access the lecture notes at the following links.
  ...
  - [Week 11 · Classification and Clustering](./compmus20201-w11.html)
...
The performance of the classifier is mediocre: overall classification accuracy is 55 percent, with a J-index of 0.32. Although these features are reasonably effective at identifying the party and pop playlists, the precision of the classifier's predictions of workout tracks is very low: when the classifier predicts that a track is a workout track, it is just as likely to be a party or pop track. 
