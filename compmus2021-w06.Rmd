---
title: "Meeting Plan · Week 6"
author: "John Ashley Burgoyne"
date: "10 February 2021"
output: html_document
---

You can download the raw source code for these lecture notes [here](./compmus2021-w06.Rmd).

## Agenda

### 11.00 · Intro

- Lecture: What is computational musicology? (15 mins)
- Breakout 1: Spotify features (15 mins)
- Plenary Discussion: Breakout findings (10 mins)
- Break (5 mins)

### 11.45 · Spectrograms and Visualisations

- Lecture: What is a spectrogram? (15 mins)
- Demo: Sonic Visualiser (15 mins)
- Lecture: What is good analytical design? (15 mins)

### 12.30 · Lunch

- If you want some distraction, have a look at the [Sources of Good Data Visualisations](https://canvas.uva.nl/courses/22328/modules/items/834112) on Canvas.

### 13.00 · Spotify API

- Review: Spotify, Github Pages, and R Markdown (15 mins)
- Breakout 2: 'Let It Go' (20 mins)
- Plenary Discussion: Breakout findings (5 mins)
- Break (5 mins)

### 13.45 · ggplot

- Demo: ggplot (15 mins)
- Breakout 3: Digster decade comparison (20 mins)
- Plenary Discussion: Breakout findings (10 mins)
...
Visit the [Spotify feature documentation](https://developer.spotify.com/documentation/web-api/reference/#object-audiofeaturesobject). It is quite short -- and Spotify provides no other explanation of what their features mean.
...
If you interacted with any young children in your life a few years ago, you also surely interacted with the Disney hit 'Let It Go', from *Frozen*. What about this song made it so irresistibly popular? You and your group will try to use the Spotify API to see if there is anything unusual about it.
...
Open the [Disney Hits](https://open.spotify.com/playlist/37i9dQZF1DX8C9xQcOrE6T?si=brcY2gRMTEeLA73yteEw_A) playlist on Spotify and load it into R, like the demo examples above. Look at the data, starting in spreadsheet form, and compare 'Let It Go' to the other tracks on the playlist. Is there anything unusual about it? Be prepared to discuss your findings with the group.
