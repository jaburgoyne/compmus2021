---
title: "Week 8 · Structure Analysis · Self-Similarity Matrices"
...
You can download the raw source code for these lecture notes [here](./compmus2021-w08.Rmd).

## Agenda

### 11.00 · Portfolio Critiques

### 11.30 · Self-Similarity Matrices

  - Lecture: Self-similarity matrices (10 mins)
  - Break (5 mins)

### 11.45 · MFCCs

  - Lecture: MFCCs and Spotify's timbre feature (20 mins)
  - Breakout: 'Maria' (15 mins)
...
### 13.50 · Self-Similarity Matrices

  - Demo: Self-similarity matrices with compmus (5 mins)
...
Below, you can see two self-similarity matrices for the [Dave Brubeck Quartet's rendition of Leonard Berntein's 'Maria'](https://open.spotify.com/track/76du1Dx2WufWkVdkB9UsxV?si=IRFdm57UTuuXpiZUwVrNYA) (from *West Side Story*). Listen to the piece together and try to explain the patterns you see in the matrices.
...
library(compmus)
maria <-
  get_tidy_audio_analysis("76du1Dx2WufWkVdkB9UsxV") %>%
