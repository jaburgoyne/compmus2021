---
title: "Week 19 · Key and Chord Estimation"
...
You can download the raw source code for these lecture notes [here](./compmus2021-w09.Rmd).

## Agenda

### 11.00 · Automatic Chord Estimation

  - Demo: Chordify (10 mins)
  - Lecture: Chordograms (30 mins)
  - Break: 5 mins

### 11.45 · Cross-Cultural Comparisons

  - Portfolio critiques (15 mins)
  - Breakout: Grease and the sitar (20 mins)
...
### 13.00 · Chordograms
  ...
  - Demo: Chordograms with the Spotify API (15 mins)
  - Breakout: Chordograms (20 mins)
  - Discussion: Breakout results (5 mins)
  - Break (5 mins)
...
**IMPORTANT:** First install the updated `compmus` package by running `remotes::install_github('jaburgoyne/compmus')`. It fixes a bug in computing
chordograms.
...
Listen to the track and discuss the following questions with your group.
  ...
  - What happens at about 3:00? Why does the pattern in the chordogram changes?
